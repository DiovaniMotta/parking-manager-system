...
public class PersistenceSessionSequenceConfiguracao implements PersistenceSession<Configuracao>{

	private SessionFile sessionFile;
	
	public PersistenceSessionSequenceConfiguracao() throws IOException, ValidatePropertyException {
		sessionFile = SessionAbstractFactory.create(Persistencia.TEXTO).getSession();
		sessionFile.createRootDirectory("sequence");
		sessionFile.createFile("configuracao.js");
	}
