...
public class PersistenceSessionSequenceVeiculo implements PersistenceSession<Veiculo> {

	private SessionFile sessionFile;
	
	public PersistenceSessionSequenceVeiculo() throws IOException, ValidatePropertyException {
		sessionFile = SessionAbstractFactory.create(Persistencia.TEXTO).getSession();
		sessionFile.createRootDirectory("sequence");
		sessionFile.createFile("veiculo.js");
	}
