...
public class PersistenceSessionSequenceVaga implements PersistenceSession<Vaga> {

	private SessionFile sessionFile;

	
	public PersistenceSessionSequenceVaga() throws IOException, ValidatePropertyException {
		sessionFile = SessionAbstractFactory.create(Persistencia.TEXTO).getSession();
		sessionFile.createRootDirectory("sequence");
		sessionFile.createFile("vagas.js");
	}
